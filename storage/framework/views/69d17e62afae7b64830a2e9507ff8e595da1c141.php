     ...
     <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="<?php echo e(route('home')); ?>">
         ...
         <a class="navbar-brand pt-0" href="<?php echo e(route('properties')); ?>">
             <h1 style="color: #cfcfcf; font-weight: 800; "><i class="fas fa-lightbulb"></i> SGI</h1>
         </a>
         <!--<div align="center">
                 ...
                 <div class="row">
                     <div class="col-6 collapse-brand">
                         <a href="<?php echo e(route('home')); ?>">
                             <h1 style="color: #1e1a55; font-weight: 800; "><i class="fas fa-city"></i> SGI</h1>
                         </a>
                     </div>
             ...
             <ul class="navbar-nav">
                 ...
                 <li class="nav-item">
                     <a class="nav-link active" href="<?php echo e(route('properties')); ?>" role="button" aria-expanded="true"
                         ...
                         <span class="nav-link-text" style="color: #cfcfcf;"><?php echo e(__('Ativos Imobiliários')); ?></span>
                     </a>
                 <li class="nav-item">
                     <a class="nav-link active" href="<?php echo e(route('partners')); ?>" role="button" aria-expanded="true"
                         ...
                         <span class="nav-link-text"
                             style="color: #cfcfcf;"><?php echo e(__('Sócios e Participações')); ?></span>
                     </a>
                 </li>
                 <!--
                    <li class="nav-item">
                     <a class="nav-link active" href="<?php echo e(route('expense')); ?>" role="button" aria-expanded="true"
                         ...
                         <span class="nav-link-text"
                             style="color: #cfcfcf;"><?php echo e(__('Despesas dos Ativos Imobiliários')); ?></span>
                     </a>
                 </li> --> 
...
<?php /**PATH /home/fabio/Documentos/Projetos/SGI/resources/views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>