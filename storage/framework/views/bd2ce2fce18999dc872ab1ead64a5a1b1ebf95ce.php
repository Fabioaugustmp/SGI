            ...
            <!--<li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default  dropdown-menu-right ">
                    <div class="row shortcuts px-4">
                        ...
                        <a href="<?php echo e(route('users')); ?>" class="col-4 shortcut-item">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <span><?php echo e(__('Configurações')); ?></span>
                    </a>
                    <!--<a href="#" class="dropdown-item">
                        <i class="ni ni-calendar-grid-58"></i>
                        <span><?php echo e(__('Atividade')); ?></span>
                    </a>
                    <a href="#" class="dropdown-item">
                        <i class="ni ni-support-16"></i>
                        <span><?php echo e(__('Suporte')); ?></span>
                    </a>-->
...
<?php /**PATH /home/fabio/Documentos/Projetos/iMCLG/resources/views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>