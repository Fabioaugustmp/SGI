                                    ...
                                    <div class="container">
                                        ...
                                        <div class="text-start">
                                            <button type="submit" class="btn btn-primary btn-outline-primary mt-4"><i class="fa fa-save"
                                                    aria-hidden="true"></i> <?php echo e(__('Salvar Imagem')); ?></button>
                                            <button type="submit" class="btn btn-primary btn-outline-primary mt-4"><i class="fa fa-save"
                                                    aria-hidden="true"></i> <?php echo e(__('Salvar & Adicionar')); ?></button>
...
<?php echo $__env->make('layouts.app', ['title' => __('Ativos')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fabio/Documentos/Projetos/iMCLG/resources/views/properties/uploads/images/properties-add-images.blade.php ENDPATH**/ ?>