                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small><?php echo e(__('Resetar senha')); ?></small>
                        </div>
                        ...
                        <form role="form" method="POST" action="<?php echo e(route('password.email')); ?>">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary my-4"><?php echo e(__('Enviar Link de Reset de Senha')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg-default'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fabio/Documentos/Projetos/iMCLG/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>