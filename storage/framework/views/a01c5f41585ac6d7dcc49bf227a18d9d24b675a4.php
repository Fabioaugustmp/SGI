            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <form role="form" method="POST" action="<?php echo e(route('construction.add')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                                    ...
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>"
                                            placeholder="<?php echo e(__('Construção')); ?>" type="text" name="name"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control <?php echo e($errors->has('description') ? ' has-danger' : ''); ?>" id="description" rows="5" name="description"
                                        placeholder="Informe uma breve descricao da construção ..." required value="<?php echo e(old('description')); ?>"></textarea>
...
<?php echo $__env->make('layouts.app', ['title' => __('Tipos de Construção')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fabio/Documentos/Projetos/iMCLG/resources/views/construction/construction-create.blade.php ENDPATH**/ ?>