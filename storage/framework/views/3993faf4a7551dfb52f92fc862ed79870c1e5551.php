                        ...
                        <form role="form" method="POST" action="<?php echo e(route('users/create')); ?>">
                            ...
                            <div class="text-left">
                                <button type="submit" class="btn btn-primary mt-4"><i class="fa fa-user-plus"
                                        aria-hidden="true"></i> <?php echo e(__(' Criar conta')); ?></button>
                                <a href="<?php echo e(route('users')); ?>" class="btn btn-primary mt-4" type="button">
...
<?php echo $__env->make('layouts.app', ['title' => __('Usuários')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fabio/Documentos/Projetos/iMCLG/resources/views/users/users-create.blade.php ENDPATH**/ ?>