                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('users')); ?>"><?php echo e($title); ?></a>
                                    </li>
...
<?php /**PATH /home/fabio/Documentos/Projetos/iMCLG/resources/views/users/partials/header-profile.blade.php ENDPATH**/ ?>