                    ...
                    <div class="card-body">
                        <div class="card-header bg-white border-0 justify-content-end">
                            ...
                            <div class="row justify-content-end">
                                <a href="<?php echo e(route('filetype.create')); ?>" class="btn btn-icon btn-3 btn-primary btn-outline-primary"
                                    ...
                                    <?php $__currentLoopData = $filetype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="justify-content-center">
                                                <a class="btn btn-outline-primary" href="<?php echo e(route('filetype.show' , $type->id )); ?>"><i class="fas fa-edit"></i></a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.app', ['title' => __('Tipos de Anexo')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fabio/Documentos/Projetos/iMCLG/resources/views/filetype/filetype.blade.php ENDPATH**/ ?>