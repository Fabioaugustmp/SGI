                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="row justify-content-start">
                                        <h2 style="text-transform: uppercase;"><i class="far fa-hand-point-right"></i> <?php echo e($properties->name); ?></h2>
                                    </div>
                                </div>
                                <div class="col-6">
...
<?php echo $__env->make('layouts.app', ['title' => __('Ativos')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fabio/Documentos/Projetos/SGI/resources/views/properties/properties-show-expenses.blade.php ENDPATH**/ ?>